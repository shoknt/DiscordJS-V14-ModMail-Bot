...
const client = new Client(
  {
    ...
    presence: {
      activities: [{
        ...
        type: 1,
        url: "https://www.youtube.com/watch?v=FyrD0Zsu2S8"
      }]
    },
    shards: "auto"
  }
...
██║░╚═╝░██║╚█████╔╝██████╔╝██║░╚═╝░██║██║░░██║██║███████╗
╚═╝░░░░░╚═╝░╚════╝░╚═════╝░╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝╚══════╝
`.underline.blue + `Version ${projectVersion} By The Extremez Coder.
`.underline.cyan;
          ...
          new EmbedBuilder()
            ...
            .addFields(
              ...
              },
              {
                ...
                value: "Unfortunately, you are not allowed to reshare this code from Insidious#9123. Please DM him and ask the permission to share, else you will get a copyright warning from him. Thanks :)"
              }
            )
            .setColor('Blue')
            .setFooter(
              {
                text: "Developed by: Insidious#9123"
              }
            )
        ],
        ephemeral: true
